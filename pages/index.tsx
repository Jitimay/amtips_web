      ...
      <div className="root">
        ...
        <nav className="nav">
          ...
          <div className={`nav-links ${menuOpen ? 'open' : ''}`}>
            ...
            <a href="/amTips_V1.0.apk" className="btn-nav" target="_blank" rel="noreferrer" id="nav-download-btn">
              Download Free
            </a>
          </div>
          ...
          <div className="hero-inner">
            <div className="hero-text">
              ...
              <div className="hero-actions">
                <a href="/amTips_V1.0.apk" className="btn-primary" target="_blank" rel="noreferrer" id="hero-download-btn">
        ...
        <section className="cta">
          ...
          <div className="cta-inner">
            ...
            <a href="/amTips_V1.0.apk" className="btn-cta" target="_blank" rel="noreferrer" id="cta-download-btn">
